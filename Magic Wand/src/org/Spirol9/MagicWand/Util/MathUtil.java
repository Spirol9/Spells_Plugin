...
public class MathUtil {
  ...
  public static void drawSinWave(String effect, Plugin plugin, Player p, double period,
  ...
  public static void drawCosWave(String effect, Plugin plugin, Player p, double period,
      double amplitude, double intervalX, double offsetY, boolean playFromPlayerSight) {
